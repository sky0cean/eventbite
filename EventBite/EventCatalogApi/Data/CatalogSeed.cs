    ...
    public static class CatalogSeed
    {
        ...
        private static IEnumerable<CatalogItem> GetPreConfiguredCatalogItems()
        {
            return new List<CatalogItem>()
            {
                ...
                new CatalogItem { CatalogCategoryId=7, CatalogFormatId=3, Description = "The human body is 90% water so we’re basically just cucumbers with anxiety. Discussion & Support by Dr Spiritual", Name = "Quarantine days? open yourself!", Price = 0.00M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/4" },
                ...
                new CatalogItem { CatalogCategoryId=2, CatalogFormatId=4, Description = "Experience the culture beauty and spirit of the Polynesian Islands.", Name = "polynesian culture festival", Price = 12.99M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/6" },
                ...
                new CatalogItem { CatalogCategoryId=8, CatalogFormatId=7, Description = "Let's take good care of our animals.", Name = "PET CLASS 2020", Price = 0.00M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/8" },
                ...
                new CatalogItem { CatalogCategoryId=4, CatalogFormatId=8, Description = "OUT MAY 5th FEAT.TIMELESS PRE-ORDER NOW, Nights we won’t remember with people we won’t forget.", Name = "Jon Bavi 2020", Price = 12.99M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/16" },
                ...
                new CatalogItem { CatalogCategoryId=6, CatalogFormatId=8, Description = "We have nothing to lose and a world to sea. All Weekend of July", Name = "Sat Surf School", Price = 0.00M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/20" },
                ...
                new CatalogItem { CatalogCategoryId=2, CatalogFormatId=5, Description = "Re-think your food. First, we eat, then we can do everything else.", Name = "Discover your way to gourmet", Price = 0.00M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/22" },
                new CatalogItem { CatalogCategoryId=1, CatalogFormatId=2, Description = "Kyobi Cooking school.", Name = "Season it jut right!", Price = 0.00M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/23" },
                ...
                new CatalogItem { CatalogCategoryId=8, CatalogFormatId=7, Description = "A good teacher can inspire hope, ignite the imagination, and instill a love of learning. ― Brad Henry", Name = "Art class", Price = 12.99M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/25" },
                new CatalogItem { CatalogCategoryId=6, CatalogFormatId=9, Description = "A brighter future for all.", Name = "Pre-K, summar school", Price = 12.99M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/26" },
                ...
                new CatalogItem { CatalogCategoryId=7, CatalogFormatId=1, Description = "Anime Weekend New York is the largest Anime Convention in the eastcoast.", Name = "Anime Weekend 2020", Price = 12.99M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/29" }
            };
