    ...
    public static class CatalogSeed
    {
        ...
        private static IEnumerable<CatalogItem> GetPreConfiguredCatalogItems()
        {
            return new List<CatalogItem>()
            {
                ...
                new CatalogItem { CatalogCategoryId=5, CatalogFormatId=4, Description = "Experience the culture beauty and spirit of the Polynesian Islands.", Name = "polynesian culture festival", Price = 12.99M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/6" },
                ...
                new CatalogItem { CatalogCategoryId=2, CatalogFormatId=2, Description = "Kyobi Cooking school.", Name = "Season it jut right!", Price = 0.00M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/23" },
                ...
                new CatalogItem { CatalogCategoryId=8, CatalogFormatId=1, Description = "Anime Weekend New York is the largest Anime Convention in the eastcoast.", Name = "Anime Weekend 2020", Price = 12.99M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/29" }
            };
